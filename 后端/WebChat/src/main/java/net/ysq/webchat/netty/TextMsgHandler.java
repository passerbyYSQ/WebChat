...
public class TextMsgHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, TextWebSocketFrame msg) throws Exception {
        ...
        MsgModel msgModelTmp = JsonUtils.jsonToObj(msg.text(), MsgModel.class);
        // 消息类型
        Integer action = msgModelTmp.getAction();
        ...
        if (action.equals(MsgActionEnum.BIND.type)) {
            ...
            MsgModel<String> msgModel = JsonUtils.jsonToObj(
                    msg.text(), new TypeReference<MsgModel<String>>() {});
            String token = msgModel.getData();
            ...
            MsgModel<SingleChatMsgRequest> msgModel = JsonUtils.jsonToObj(
                    msg.text(), new TypeReference<MsgModel<SingleChatMsgRequest>>() {});
            SingleChatMsgRequest data = msgModel.getData();
            ...
            MsgModel<String> msgModel = JsonUtils.jsonToObj(
                    msg.text(), new TypeReference<MsgModel<String>>() {});
            String msgIdsStr = msgModel.getData();
